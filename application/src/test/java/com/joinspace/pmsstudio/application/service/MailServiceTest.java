...
import com.joinspace.pmsstudio.notification.MailServiceImpl;
...
public class MailServiceTest {
    ...
    public void setup() {
        ...
        mailService = new MailServiceImpl(applicationProperties, javaMailSender, templateEngine, messageSource);
    }
    ...
    public void testSendEmailFromTemplate() throws Exception {
        ...
        assertThat(message.getFrom()[0].toString()).isEqualTo("test@localhost");
        assertThat(message.getContent().toString()).contains("test title, http://127.0.0.1:8085, john");
        assertThat(message.getDataHandler().getContentType()).isEqualTo("text/html;charset=UTF-8");
    }
