...
import com.joinspace.pmsstudio.repository.AuthorityRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public UserServiceImpl(UserRepository userRepository, PasswordEncoder passwordEncoder, AuthorityRepository authorityRepository, CacheManager cacheManager) {
    ...
    public Page<UserDTO> getAllManagedUsers(Pageable pageable) {
        return userRepository.findAllByUsernameNot(pageable, AppConstants.ANONYMOUS_USER).map(UserDTO::new);
    }
